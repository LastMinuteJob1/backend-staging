...
class TermsAndConditionController {
    constructor() {
        this.termsAndConditionService = new terms_service_1.TermsAndConditionService();
        this.addFAQ = (req, res) => __awaiter(this, void 0, void 0, function* () {
            let data = yield this.termsAndConditionService.addFAQ(req, res);
            if (data != null)
                res.send((0, methods_1.sendResponse)(data));
        });
        this.getFAQ = (req, res) => __awaiter(this, void 0, void 0, function* () {
            let data = yield this.termsAndConditionService.getFAQ(req, res);
            if (data != null)
                res.send((0, methods_1.sendResponse)(data));
        });
    }
}
exports.TermsAndConditionController = TermsAndConditionController;
