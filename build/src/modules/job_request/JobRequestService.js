    ...
    constructor() {
        ...
        this.toggle_request_proposals = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const user = yield (0, methods_1.getUser)(req);
                if (user == null) {
                    res.status(409).send((0, error_1.sendError)("Authentication failed, please login again"));
                    return null;
                }
        ...
        this.toggle_accepted_job_request_for_review = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (status == JobRequestInterface_1.JobRequestStatus.COMPLETED) {
                    ...
                    this.emailService.send({
                        from: env_1.EMAIL_USERNAME, to: email,
                        text: `Dear ${worker["fullname"].split(" ")[0]} <br> Unfortunately has been rejected, try as much as possible to improve the service provided `,
