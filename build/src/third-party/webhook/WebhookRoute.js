...
webHookRoute.post("/process-payment/stripe/SmlsbyBCaWxsaW9uYWlyZQ", /*stripe_authorization*/ express.raw({ type: 'application/json' }), webhookCOntroller.process_stripe_payment);
